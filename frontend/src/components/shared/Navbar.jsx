    ...
    <div className="bg-white">
      <div className="flex items-center justify-between mx-auto max-w-7xl h-16">
        <div className="flex items-end">
          <img src = {logo} className="p-1 w-12 h-15"></img>
                      ...
                      <div className="flex flex-col my-2 text-gray-600">
                        {
                          user && user.role == "jobSeeker" && (
                            <div className="flex w-fit items-center gap-2 cursur-pointer">
                              <User2 />
                        ...
                        <div className="flex w-fit items-center gap-2 cursur-pointer">
                          <LogOut />
                          <Button onClick={logoutHandler} variant="link"><Link>logout</Link></Button></div>
                      </div>
                    </div>
                  </PopoverContent>
                </Popover>
